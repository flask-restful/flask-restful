    ...
    def test_parse_required(self):
        ...
        with app.app_context():
            ...
            try:
                ...
                message = e.data['message']
            self.assertEquals(message, (u'{"bar": "Missing required parameter '
                                    'in the post body or the query string or the '
                                    'request\'s cookies"}'))
    ...
    def test_parse_error_bundling(self):
        ...
        with app.app_context():
            ...
            try:
                ...
                message = e.data['message']
            error_message = (u'{"foo": "Missing required parameter in the post '
                'body or the query string"}, {"bar": "Missing required '
